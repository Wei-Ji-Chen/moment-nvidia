...
NOTES = "Train GPT4TS on source short-horizon forecasting datasets"

HORIZON_MAPPING = {'hourly': 48, 'daily': 14, 'weekly': 13, 'monthly': 18, 'other': 8, 'quarterly': 8, 'yearly': 6}

def forecasting(
    config_path: str = '../../configs/forecasting/gpt4ts.yaml',
...
if __name__ == '__main__':
    ...
    parser.add_argument('--init_lr', type=float, default=0.002, help='Peak learning rate') 
    parser.add_argument('--finetuning_mode', type=str, default='end-to-end', help='Finetuning mode')
