### Code for ranged and VUS AUC and PRAUC adapted from XXXX
### Code for adjusted best F1 adapted from XXXX
...
def get_anomaly_detection_metrics(anomaly_scores : NDArray, 
                                  labels : NDArray,
    ...
    return AnomalyDetectionMetrics(adjbestf1=_adjbestf1, raucroc=raucroc, 
                                   raucpr=raucpr, vusroc=vusroc, vuspr=vuspr)
