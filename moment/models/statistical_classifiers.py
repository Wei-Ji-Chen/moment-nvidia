...
def fit_svm(features: npt.NDArray, 
            y: npt.NDArray, 
...
def fit_lr(features : npt.NDArray, 
           y : npt.NDArray, 
...
def fit_knn(features : npt.NDArray, 
            y : npt.NDArray):
    pipe = make_pipeline(
        StandardScaler(),
...
def fit_ridge(train_features : npt.NDArray, 
              train_y : npt.NDArray, 
