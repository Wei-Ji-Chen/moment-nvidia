...
class TimesNet(nn.Module):
    ...
    def reconstruct(self, x_enc, mask=None, **kwargs):
        ...
        return TimesNetOutputs(reconstruction=dec_out, timeseries=x_enc, mask=mask[:, 0, :])
    ...
    def pretraining(self, 
        ...
        return TimesNetOutputs(reconstruction=dec_out, timeseries=x_enc, pretrain_mask=mask[:, 0, :])
    ...
    def detect_anomalies(self, 
        ...
        return TimesNetOutputs(reconstruction=outputs.reconstruction,
